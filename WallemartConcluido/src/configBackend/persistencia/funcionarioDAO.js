const Funcionario = require("../modelo/funcionario.js");
const conecta = require("./conexao.js");
...
class FuncionarioDAO {
    ...
    async excluir(funcionario) {
        if (funcionario instanceof Funcionario) { //usa a classe de objetos
            const conexao = await conecta();
